...
# We also need to create the default TLS secret for the ingress controller. We use our *.nginxdemo.net cert/key pair here.

cat ~/certs/nginxdemo.net.crt.pem ~/certs/nginxdemo.net.issuer.pem >~/certs/nginxdemo.net.fullchain.pem

kubectl create secret tls default-server-secret --key=certs/nginxdemo.net.key.pem --cert=certs/nginxdemo.net.fullchain.pem
